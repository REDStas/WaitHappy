...
@implementation REDSurvayEmail
@synthesize message, messageID, businessID, type, _myTitle, businessLink, messageText;
...
- (void)viewDidLoad
{
    ...
    //[myFavoritesLbl setText:self.title];
    ...
    //[myTextView setText:self.message];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //myTextView.text = [NSString stringWithFormat:@"While you are here, please provide feedback about your visit at. \n\nThis feedback will go directly to the store manager earn you WaitHappy points!"];
    //NSString *caption = [self._myTitle substringFromIndex:31];
    
    NSArray *array = [self.messageText componentsSeparatedByString:@"--separator--"];
    [subjectLabel setText:[array objectAtIndex:0]];
    [myTextView setText:[array objectAtIndex:1]];
    [myFavoritesLbl setText:[[NSString stringWithFormat:@"NOTE FROM %@", [array objectAtIndex:2]] uppercaseString]];
